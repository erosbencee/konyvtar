...
CREATE TABLE `kvt_event_history` (
  ...
  `EVENT_BEGAN` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `EVENT_ENDED` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `EXPECTED_PPL` int(3) NOT NULL,
  `ATTENDED_PPL` int(3) NOT NULL,
